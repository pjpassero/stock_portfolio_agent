...
graph.add_edge("build_covariance_matrix", "calculate_score")
graph.add_edge("build_covariance_matrix", "calculate_etf_score")
graph.add_edge("calculate_etf_score", END)
